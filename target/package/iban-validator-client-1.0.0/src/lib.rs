//! # Global IBAN, BIC/SWIFT & Bank Routing Validator API — Rust Client SDK
//!
//! Official client for Global IBAN, BIC/SWIFT & Bank Routing Validator API on RapidAPI.
//! Obtain your API key at: <https://rapidapi.com/noor-mkdad-apis-noor-mkdad-apis-default/api/global-iban-bic-swift-bank-routing-validator-api>
...
/// Client configuration for Global IBAN, BIC/SWIFT & Bank Routing Validator API.
#[derive(Debug, Clone)]
...
impl Default for RapidApiConfig {
    fn default() -> Self {
        Self {
            ...
            base_url: "https://global-iban-bic-swift-bank-routing-validator-api.p.rapidapi.com".to_string(),
            rapidapi_host: "global-iban-bic-swift-bank-routing-validator-api.p.rapidapi.com".to_string(),
        }
    }
}

/// Main client for Global IBAN, BIC/SWIFT & Bank Routing Validator API.
